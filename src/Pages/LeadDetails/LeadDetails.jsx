                ...
                <div className='flex flex-col md:w-[40%] lg:w-[30%] gap-7'>
                    <div className=" bg-white dark:bg-[#2F3249] w-full  shadow-2xl rounded-lg border dark:border-none pb-10 ">
                        ...
                        <div className="text-center ">
                            <h1 className="mt-2 text-2xl dark:text-white text-black">Khan Tassen Islam</h1>
                        </div>
                        {/* WB-MR-0012 button */}
                        <button className="w-[24%] md:w-[32%] xl:w-[33%]  border mx-auto rounded-lg text-white text-xs xl:text-lg bg-blue-500  font-bol mb-3 dark:border-none dark:text-white text-center">WB-MR-0012</button>
                        ...
                        <div className=" pr-2 pl-4 mt-5">
                            ...
                            <p className="text-xl flex  justify-start gap-2 m-0">
                                <span className=" font-bold text-black w-[18%]">Address : </span>
                                <span className='text-lg w-[80%]'>Jalal Plaza (2nd floor), 84, CDA Avenue, Muradpur, Chittagong, Chattogram 4000</span>
                            </p>
                            <p className="text-xl flex items-start justify-start gap-2 m-0">
                                <span className=" font-bold text-black">District : </span>Chittagong
                            </p>
                            <p className="text-xl flex items-start justify-start gap-2 m-0">
                                <span className=" font-bold text-black">Interest : </span>40%
                            </p>
                            <p className="text-xl flex items-start justify-start gap-2 m-0">
                                <span className="font-bold  text-black">Google Map : </span>Map Link
                            </p>
                        </div>
                    ...
                    <div className='bg-white dark:bg-[#2F3249]  shadow-2xl rounded-lg border dark:border-none '>
                        <div className=' flex justify-between items-center px-2  border-b border mb-10'>
                            ...
                            <button className='border-none text-white bg-warning p-2 rounded-md'>Processing</button>
                        </div>
                        <hr />
                        <div className='px-2 pb-2'>
                            <button className='border-none text-white bg-blue-500 p-2 rounded-md mt-2 w-full  text-lg'>Change Status</button>
