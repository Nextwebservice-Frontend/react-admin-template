  ...
  return (
    <>
      <div className="flex gap-10">
        ...
        <div className="border mt-7 mx-auto rounded shadow-2xl pb-16">
          <div className="flex justify-between px-5 pt-5">
            <img
              className="mb-3 w-[40%] h-[150px]"
            ...
            <div className="flex flex-col items-end">
              <div className="mb-2">
                ...
                <input
                  ...
                  className="input input-bordered w-[220px] h-[40px]"
                />
              </div>
          ...
          <div className="border-y border-gray-300  pb-2 px-5">
            <h1 className="text-black text-xl mt-2 mb-2 ">
              Expanse Receipt List
            </h1>

            <table className="w-full mb-4">
              <tr>
                <td className="text-black border text-center font-extrabold text-lg bg-[#f7f7f7] py-2">
                  SN
                </td>
                <td className="text-black border text-center font-extrabold text-lg bg-[#f7f7f7] py-2">
                  Expense
          ...
          <div className="flex justify-between  mt-5 px-5">
            <h6 className="font-medium w-[50%] text-xl">
        ...
        <div className=" w-[340px] ">
          <div className="border mt-7  mx-auto  rounded ">
            <h4 className="text-lg text-black pl-3 py-2 border font-bold">
              Select Expense
            </h4>
          ...
          <div className="border mt-7  mx-auto  rounded ">
            <h4 className="text-lg text-black pl-3 py-2  font-bold">
              Receipt Notes
            </h4>
