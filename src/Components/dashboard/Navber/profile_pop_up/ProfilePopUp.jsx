...
const ProfilePopUp = ({ showProfiePopUp, setShowprofilePopUp }) => {
    return (
        <div className={`py-4 px-2 shadow mt-10 rounded box-border border min-w-[96%] max-w-[96%] sm:max-w-60 sm:min-w-60 absolute md:right-4 z-10 right-[2%] -top-8 sm:-top-12 bg-white ${showProfiePopUp ? "popup" : "hidden"}`}>
            ...
            <div className=' '>
                <Link onClick={() => { setShowprofilePopUp(false) }} to='/profile' className='my-1 flex justify-start items-center gap-3 text-gray-500 text-base hover:text-gray-500 hover:no-underline hover:bg-slate-100 p-1 rounded-md transition-all'>
