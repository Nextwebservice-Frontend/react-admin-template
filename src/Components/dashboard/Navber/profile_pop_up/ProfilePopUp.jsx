...
const ProfilePopUp = ({ showProfiePopUp, setShowprofilePopUp }) => {
    return (
        <div className={`py-4 px-2 shadow mt-10 rounded box-border border min-w-full max-w-full sm:max-w-60 sm:min-w-60 absolute md:right-4 z-10 right-0 -top-12 bg-white ${showProfiePopUp ? "popup" : "hidden"}`}>
