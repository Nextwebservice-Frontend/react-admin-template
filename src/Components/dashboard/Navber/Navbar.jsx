...
const Navbar = () => {
  ...
  return (
    <>
      <div style={{ boxShadow: 'rgba(0, 0, 0, 0.1) 1px 1px 3px 2px' }} className="flex bg-white dark:bg-[#2F3249] rounded-md justify-between items-center w-full mx-auto box-border px-2 sm:px-4 md:px-6  py-4 z-10 relative">
        {showSearchOption &&
